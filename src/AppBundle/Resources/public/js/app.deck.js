...
(function app_deck(deck, $)
{
    ...
    deck.get_layout_data = function get_layout_data(options)
    {
        ...
        if(objective) {
          deck.update_layout_section(data, 'images', $('<div class="col-sm-5 col-print-6"><div class="deck-objective"><a href="' + objective.url + '" data-toggle="modal" data-remote="false" data-target="#cardModal" data-code="' + objective.code + '"><img class="img-responsive" src="' + objective.image_url + '"/></a></div></div>'));
        }
